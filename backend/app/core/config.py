...
class Settings(BaseSettings):
    ...
    NEXT_PUBLIC_SUPABASE_URL: str = Field(default="", env="NEXT_PUBLIC_SUPABASE_URL")
    NEXT_PUBLIC_SUPABASE_ANON_KEY: str = Field(default="", env="NEXT_PUBLIC_SUPABASE_ANON_KEY")
