...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0B1220] text-slate-900 dark:text-white flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans select-none">
      ...
      <div className="w-full max-w-md premium-card p-8 relative z-10 space-y-6">
        ...
        <div className="flex flex-col items-center justify-center text-center space-y-2">
          ...
          <h2 className="text-xl font-black tracking-tight text-slate-900 dark:text-white mt-4">
        ...
        {/* Tab Selector */}
        {!showOtpScreen && (
          <div className="grid grid-cols-2 p-1 bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-2xl">
            <button
              onClick={() => handleTabToggle(false)}
              className={`py-2 text-xs font-bold rounded-xl transition-all ${ !isRegister ? 'bg-[#0F172A] dark:bg-white text-white dark:text-slate-900 shadow-sm' : 'text-slate-500 dark:text-slate-400 hover:text-slate-950 dark:hover:text-white' }`}
            >
              Sign In
            </button>
            <button
        ...
        {showOtpScreen ? (
          <form onSubmit={handleOtpVerify} className="space-y-4">
            <div className="text-center space-y-2">
              <div className="w-12 h-12 rounded-2xl bg-indigo-500/10 border border-indigo-500/25 flex items-center justify-center mx-auto text-indigo-500 dark:text-indigo-400">
                <KeyRound size={22} />
              </div>
              <h3 className="text-sm font-bold text-slate-900 dark:text-white">Verify Your Identity</h3>
            ...
            <div className="space-y-1">
              <label className="text-[10px] font-bold text-slate-400 dark:text-slate-400 uppercase tracking-wider">Verification OTP Code</label>
              <input
                type="text"
                inputMode="numeric"
                pattern="[0-9]*"
                ...
                className="w-full h-11 px-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/5 focus:border-indigo-500/50 rounded-xl text-center text-sm font-bold tracking-widest focus:outline-none text-slate-900 dark:text-white"
              />
              {otpError && <p className="text-[10px] text-red-500 font-semibold">{otpError}</p>}
            </div>

            <div className="flex items-center justify-between text-xs pt-1">
              <span className="text-slate-400 dark:text-slate-400">Resend code available in:</span>
              <button
                type="button"
            ...
            <button
              ...
              className="w-full h-11 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl text-xs flex items-center justify-center gap-1.5 transition-all shadow-md shadow-indigo-500/10"
            >
            ...
            <button
              ...
              className="w-full text-center text-xs text-slate-500 dark:text-slate-400 hover:text-slate-950 dark:hover:text-white font-bold flex items-center justify-center gap-1 pt-2"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {errorMessage && (
              <div className="p-3 bg-red-500/10 border border-red-500/20 text-red-650 dark:text-red-400 rounded-xl text-xs flex items-start gap-2.5 font-semibold">
                <AlertCircle className="w-4.5 h-4.5 shrink-0 mt-0.5" />
                <span>{errorMessage}</span>
              </div>
            )}
            {successMessage && (
              <div className="p-3 bg-green-500/10 border border-green-500/20 text-emerald-650 dark:text-green-400 rounded-xl text-xs flex items-start gap-2.5 font-semibold">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full h-11 pl-10 pr-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/5 focus:border-indigo-500/50 rounded-xl text-xs font-semibold focus:outline-none text-slate-900 dark:text-white"
                  />
            ...
            <div className="flex items-center gap-4 text-xs font-bold text-slate-500 dark:text-slate-400 border-b border-slate-200 dark:border-white/5 pb-2 select-none">
              <span className="text-[10px] text-slate-400 dark:text-slate-500 uppercase tracking-wider">Auth Method:</span>
              <button
                type="button"
                onClick={() => handleTypeToggle(false)}
                className={`transition-colors pb-1.5 ${!useMobile ? 'text-slate-900 dark:text-white border-b-2 border-indigo-600 dark:border-indigo-500' : 'text-slate-400 dark:text-slate-400 hover:text-slate-950 dark:hover:text-white'}`}
              >
                Email ID
              </button>
              <button
            ...
            {useMobile ? (
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Indian Mobile Number</label>
                <div className="relative">
                  <input
                    type="text"
                    inputMode="numeric"
                ...
                {errors.mobile && <p className="text-[10px] text-red-500 font-semibold">{errors.mobile}</p>}
              </div>
            ) : (
              <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full h-11 pl-10 pr-10 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/5 focus:border-indigo-500/50 rounded-xl text-xs font-semibold focus:outline-none text-slate-900 dark:text-white"
                />
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500 w-4 h-4" />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-500 hover:text-slate-700 dark:hover:text-white"
                >
            ...
            <div className="flex items-center gap-2 select-none py-1">
              <input
                ...
                className="rounded border-slate-200 dark:border-white/10 bg-white dark:bg-slate-900 text-indigo-600 focus:ring-0 w-4 h-4 cursor-pointer"
              />
              <label htmlFor="remember" className="text-xs text-slate-500 dark:text-slate-400 cursor-pointer font-semibold">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-11 bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-200 dark:disabled:bg-slate-800 text-white font-bold rounded-xl text-xs flex items-center justify-center gap-1.5 transition-all shadow-md shadow-indigo-500/10 mt-2"
            >
              {loading ? (
          ...
          <div className="premium-card p-6 max-w-md w-full shadow-2xl space-y-4">
            <div className="flex items-center justify-between border-b border-slate-200 dark:border-white/5 pb-3">
              ...
              <button
                ...
                className="p-1 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-450 dark:text-slate-500 hover:text-slate-950 dark:hover:text-white"
              >
                <X size={16} />
              </button>
            </div>
            ...
            {forgotSuccess ? (
              <div className="text-center py-6 space-y-3">
                ...
                <h4 className="text-sm font-bold text-slate-900 dark:text-white">Password Reset Successful</h4>
                <p className="text-xs text-slate-550 dark:text-slate-400">Your account credentials have been successfully updated.</p>
              </div>
            ) : forgotSent ? (
              <form onSubmit={handleResetPasswordVerify} className="space-y-4">
                <div className="p-3 bg-indigo-500/10 border border-indigo-500/20 text-indigo-650 dark:text-indigo-400 rounded-xl text-xs leading-relaxed font-semibold">
                  📧 Simulated recovery code sent! Check your notifications and enter code <strong>123456</strong> below.
                </div>

                {forgotError && (
                  <div className="p-3 bg-red-500/10 border border-red-500/20 text-red-650 dark:text-red-400 rounded-xl text-xs font-semibold">
                    {forgotError}
                  </div>
                )}

                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase">Simulated OTP Code</label>
                  <input
                    type="text"
                    required
                    value={forgotCode}
                    ...
                    className="w-full h-11 px-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-xl text-xs focus:outline-none text-slate-900 dark:text-white font-semibold"
                  />
                </div>

                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase">New Password</label>
                  <input
                    type="password"
                    required
                    ...
                    placeholder="Min 6 characters"
                    className="w-full h-11 px-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-xl text-xs focus:outline-none text-slate-900 dark:text-white"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full h-11 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl text-xs"
                >
              ...
              <form onSubmit={handleForgotPasswordSubmit} className="space-y-4">
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase">Username / Email / Mobile</label>
                  <input
                    type="text"
                    required
                    value={forgotEmail}
                    ...
                    className="w-full h-11 px-4 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-white/5 rounded-xl text-xs focus:outline-none font-semibold text-slate-900 dark:text-white"
                  />
                </div>
